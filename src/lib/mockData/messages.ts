...
export const mockThreads: Thread[] = [
  {
    id: "T001",
    subject: "Ahmed's declining Physics performance - Action needed",
    participants: [
      { name: "Mohammed Al-Rashidi", role: "Parent", avatar: "MR" },
      { name: "Mr. Khalid Al-Mutairi", role: "Teacher - Physics", avatar: "KM" },
      { name: "Dr. Sarah Al-Hamdan", role: "Teacher - Math", avatar: "SA" },
    ],
    ...
    messages: [
      {
        ...
        from: { name: "Mr. Khalid Al-Mutairi", role: "Teacher - Physics", avatar: "KM" },
        to: [{ name: "Mohammed Al-Rashidi", role: "Parent", avatar: "MR" }],
        subject: "Ahmed's declining Physics performance - Action needed",
        body: "Dear Mr. Mohammed,\n\nI hope this message finds you well. I am reaching out regarding Ahmed's performance in Physics this term. His last three assessment scores have been 79, 72, and 68 — showing a concerning downward trend.\n\nI believe the primary issues are:\n1. Missing lab sessions (2 out of 5 this term)\n2. Incomplete homework submissions (only 60% submitted)\n3. Difficulty with calculation-based problems under time pressure\n\nI would strongly recommend we schedule a meeting to discuss a plan to support Ahmed. I am also happy to provide additional practice materials.\n\nKind regards,\nMr. Khalid Al-Mutairi\nPhysics Department",
        timestamp: "Jun 10, 2024 — 09:15 AM",
        priority: "high",
        status: "read",
        hasAttachment: true,
        attachmentName: "Ahmed_Physics_Progress_Report.pdf",
      },
      {
        id: "M001b", threadId: "T001",
        from: { name: "Mohammed Al-Rashidi", role: "Parent", avatar: "MR" },
        to: [{ name: "Mr. Khalid Al-Mutairi", role: "Teacher - Physics", avatar: "KM" }],
        subject: "Re: Ahmed's declining Physics performance - Action needed",
        body: "Dear Mr. Khalid,\n\nThank you for bringing this to my attention. I was not aware the situation had become this serious. Ahmed has been spending a lot of time on his Arabic and Chemistry projects, which may have caused him to neglect Physics.\n\nI will have a serious conversation with him tonight and ensure he catches up on missed homework. Could you share the practice materials you mentioned?\n\nRegarding a meeting — I am available Tuesday and Thursday afternoons after 3pm.\n\nThank you,\nMohammed Al-Rashidi",
      ...
      },
      {
        ...
        from: { name: "Dr. Sarah Al-Hamdan", role: "Teacher - Math", avatar: "SA" },
        to: [{ name: "Mohammed Al-Rashidi", role: "Parent", avatar: "MR" }, { name: "Mr. Khalid Al-Mutairi", role: "Teacher - Physics", avatar: "KM" }],
        subject: "Re: Ahmed's declining Physics performance - Action needed",
        body: "Dear Mohammed and Khalid,\n\nI wanted to add that Ahmed's Math performance has actually improved significantly this term (+4 points). He is very strong analytically. The Physics issue is likely related to application under timed conditions rather than fundamental understanding.\n\nI can schedule a meeting this Thursday at 4pm if that works for everyone. We can put together a combined study plan.\n\nBest,\nDr. Sarah Al-Hamdan",
  ...
  },
  {
    ...
    participants: [
      { name: "Ahmed Al-Rashidi", role: "Student", avatar: "AA" },
      { name: "Dr. Layla Al-Anazi", role: "Teacher - Chemistry", avatar: "LA" },
    ],
    ...
    messages: [
      {
        ...
        from: { name: "Ahmed Al-Rashidi", role: "Student", avatar: "AA" },
        to: [{ name: "Dr. Layla Al-Anazi", role: "Teacher - Chemistry", avatar: "LA" }],
        subject: "Homework submission extension request — Chemistry Project",
      ...
      },
      {
        ...
        from: { name: "Dr. Layla Al-Anazi", role: "Teacher - Chemistry", avatar: "LA" },
        to: [{ name: "Ahmed Al-Rashidi", role: "Student", avatar: "AA" }],
    ...
    messages: [
      {
        ...
        from: { name: "Dr. Sarah Al-Hamdan", role: "Teacher - Math", avatar: "SA" },
        to: [{ name: "Ms. Reem Al-Harbi", role: "Vice Principal", avatar: "RA" }],
        subject: "Q3 Exam Schedule Confirmation — Math Department",
      ...
      },
      {
        ...
        from: { name: "Ms. Reem Al-Harbi", role: "Vice Principal", avatar: "RA" },
        to: [{ name: "Dr. Sarah Al-Hamdan", role: "Teacher - Math", avatar: "SA" }, { name: "Dr. Khalid Al-Mansouri", role: "Principal", avatar: "DK" }],
  ...
  },
  {
    ...
    participants: [
      ...
      { name: "Omar Al-Ghamdi Parent", role: "Parent", avatar: "OG" },
    ],
    ...
    messages: [
      {
        ...
        to: [{ name: "Omar Al-Ghamdi Parent", role: "Parent", avatar: "OG" }],
        subject: "URGENT: Fee payment overdue — Final notice",
        body: "Dear Parent/Guardian of Omar Al-Ghamdi,\n\nThis is a final reminder that Semester 2 school fees (SAR 15,000) have been outstanding for 45 days. Failure to settle or arrange a payment plan within 7 days may result in academic record holds.\n\nA payment plan can be arranged. Please contact the finance office at your earliest convenience.\n\nFinance Office\nAl-Noor Academy",
        timestamp: "Jun 9, 2024 — 09:00 AM",
        priority: "urgent",
        status: "read",
        hasAttachment: true,
        attachmentName: "Fee_Statement_Omar_AlGhamdi.pdf",
      },
    ],
  },
  {
    ...
    messages: [
      {
        ...
        from: { name: "Dr. Sarah Al-Hamdan", role: "Teacher - Math", avatar: "SA" },
        to: [{ name: "Dr. Khalid Al-Mansouri", role: "Principal", avatar: "DK" }],
        subject: "Math Olympiad team nominations",
        body: "Dear Dr. Khalid,\n\nI would like to formally nominate the following students for the Regional Math Olympiad:\n\n1. Ahmed Al-Rashidi (Grade 10-A) — 82/100, strong analytical skills\n2. Fatima Al-Zahrani (Grade 10-A) — 96/100, exceptional problem solver\n3. Nora Al-Otaibi (Grade 10-B) — 91/100, consistent performer\n\nAll three have been briefed and are enthusiastic. Competition date: August 15, 2024.\n\nDr. Sarah Al-Hamdan",
      ...
      },
      {
        ...
        from: { name: "Dr. Khalid Al-Mansouri", role: "Principal", avatar: "DK" },
        to: [{ name: "Dr. Sarah Al-Hamdan", role: "Teacher - Math", avatar: "SA" }],
        subject: "Re: Math Olympiad team nominations",
        body: "Excellent choices, Dr. Sarah. Please submit the formal nomination forms by June 20. The school will cover all competition fees and transportation.\n\nDr. Khalid Al-Mansouri\nPrincipal",
  ...
  },
  {
    ...
    participants: [
      { name: "Ms. Reem Al-Harbi", role: "Vice Principal", avatar: "RA" },
      { name: "Mr. Faris Al-Shammari", role: "Teacher - PE", avatar: "FS" },
      { name: "Admin Office", role: "Admin", avatar: "AO" },
    ],
