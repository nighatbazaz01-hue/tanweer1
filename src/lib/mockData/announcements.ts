...
export const announcements: Announcement[] = [
  ...
  },
  {
    ...
    author: { name: "Ms. Neha Gupta", role: "Vice Principal", avatar: "NG" },
  ...
  },
  {
    ...
    author: { name: "Dr. Mushtaq Ahmed", role: "Principal", avatar: "MA" },
    audience: ["school_wide"],
    category: "urgent",
    isPinned: true,
    isScheduled: false,
  ...
  },
  {
    ...
    body: "We are proud to celebrate our outstanding students for May 2024!\n\n🥇 Academic Excellence:\n• Fatima Sheikh (Grade 10-A) — 96% average, ranked 1st\n• Hassan Mir (Grade 11-B) — Perfect score in Urdu\n• Noor Bhat (Grade 9-A) — Best project award in Science\n\n🏅 Sports:\n• Aarav Sharma — 1st place, Regional Math Olympiad (nominated)\n• Omar Malik — Cricket team MVP\n\n🎖 Character Award:\n• Riya Kaul (Grade 12-A) — Community Service Excellence\n\nCongratulations to all our champions!\n\nThe Tanweer Team",
    author: { name: "Dr. Mushtaq Ahmed", role: "Principal", avatar: "MA" },
    audience: ["school_wide"],
  ...
  {
    id: "A008",
    title: "🗓️ Winter Break Schedule — Coming Soon",
    body: "In preparation for the upcoming Winter Break, the following schedule adjustments will take effect:\n\n• School hours during the last week: 08:00 AM — 12:30 PM\n• All pending assignments must be submitted before December 20\n• Cafeteria will remain open till 12:00 PM during the shortened week\n• Exams and assessments will be rescheduled as required\n\nFull details will be shared one week in advance. Parents are requested to update their contact information in the Parent Portal.\n\nSchool Administration",
    author: { name: "School Administration", role: "Admin", avatar: "SA" },
    audience: ["school_wide"],
    category: "administrative",
    isPinned: false,
    isScheduled: true,
    scheduledFor: "Dec 10, 2024",
    publishedAt: "Scheduled",
    readCount: 0,
    totalAudience: 1247,
    attachments: [],
    tags: ["schedule", "winter-break", "upcoming"],
  },
];
