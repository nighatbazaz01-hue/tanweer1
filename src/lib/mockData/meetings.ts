...
export const meetings: Meeting[] = [
  {
    ...
    organizer: { name: "Ms. Reem Al-Harbi", role: "Vice Principal", avatar: "RA" },
    attendees: [
      { name: "Dr. Sarah Al-Hamdan", role: "Math Teacher", avatar: "SA", rsvp: "accepted" },
      { name: "Mr. Khalid Al-Mutairi", role: "Physics Teacher", avatar: "KM", rsvp: "accepted" },
      { name: "Dr. Layla Al-Anazi", role: "Chemistry Teacher", avatar: "LA", rsvp: "accepted" },
      { name: "Ms. Reem Al-Harbi", role: "English Teacher", avatar: "RA", rsvp: "accepted" },
      { name: "Mr. Hassan Al-Shehri", role: "Arabic Teacher", avatar: "HA", rsvp: "pending" },
      { name: "Mohammed Al-Rashidi", role: "Parent (Ahmed)", avatar: "MR", rsvp: "accepted" },
    ],
    date: "June 15, 2024",
    time: "09:00 AM",
    endTime: "12:00 PM",
  ...
  },
  {
    ...
    organizer: { name: "Dr. Khalid Al-Mansouri", role: "Principal", avatar: "DK" },
    attendees: [
      { name: "Ms. Reem Al-Harbi", role: "Vice Principal", avatar: "RA", rsvp: "accepted" },
      { name: "Dr. Sarah Al-Hamdan", role: "Math HOD", avatar: "SA", rsvp: "accepted" },
      { name: "Mr. Khalid Al-Mutairi", role: "Science HOD", avatar: "KM", rsvp: "accepted" },
      { name: "Mr. Hassan Al-Shehri", role: "Arabic HOD", avatar: "HA", rsvp: "accepted" },
      { name: "Ms. Noura Al-Zaid", role: "Arts HOD", avatar: "NZ", rsvp: "declined" },
    ],
    date: "June 16, 2024",
    time: "07:30 AM",
    endTime: "08:30 AM",
  ...
  },
  {
    ...
    organizer: { name: "Ms. Reem Al-Harbi", role: "Vice Principal", avatar: "RA" },
    attendees: [
      { name: "Dr. Khalid Al-Mansouri", role: "Principal", avatar: "DK", rsvp: "accepted" },
      { name: "Dr. Sarah Al-Hamdan", role: "Math Teacher", avatar: "SA", rsvp: "accepted" },
      { name: "Mr. Khalid Al-Mutairi", role: "Physics Teacher", avatar: "KM", rsvp: "accepted" },
  ...
  {
    id: "MTG004",
    title: "One-on-One: Ahmed Al-Rashidi Physics Support",
    description: "Dedicated session with Ahmed and his parent to discuss Physics performance decline and create a recovery plan.",
    organizer: { name: "Mr. Khalid Al-Mutairi", role: "Physics Teacher", avatar: "KM" },
    attendees: [
      { name: "Mohammed Al-Rashidi", role: "Parent", avatar: "MR", rsvp: "accepted" },
      { name: "Ahmed Al-Rashidi", role: "Student", avatar: "AA", rsvp: "accepted" },
      { name: "Dr. Sarah Al-Hamdan", role: "Math Teacher", avatar: "SA", rsvp: "accepted" },
    ],
    date: "June 15, 2024",
    time: "04:00 PM",
  ...
  },
  {
    ...
    description: "Quarterly board meeting to review academic performance, financial health, and strategic direction of Al-Noor Academy.",
    organizer: { name: "Dr. Khalid Al-Mansouri", role: "Principal", avatar: "DK" },
    attendees: [
  ...
  },
  {
    ...
    organizer: { name: "Dr. Sarah Al-Hamdan", role: "Math HOD", avatar: "SA" },
    attendees: [
      { name: "Mr. Tariq Al-Yami", role: "Math Teacher", avatar: "TA", rsvp: "accepted" },
      { name: "Mr. Nasser Al-Qahtani", role: "Math Teacher", avatar: "NA", rsvp: "accepted" },
      { name: "Ms. Hessa Al-Subaie", role: "Math Teacher", avatar: "HS", rsvp: "pending" },
    ],
    date: "June 17, 2024",
    time: "02:30 PM",
    endTime: "04:00 PM",
  ...
  },
  {
    ...
    organizer: { name: "Ms. Reem Al-Harbi", role: "Vice Principal", avatar: "RA" },
    attendees: [
      { name: "Mr. Faris Al-Shammari", role: "Grade 8-C Teacher", avatar: "FS", rsvp: "accepted" },
