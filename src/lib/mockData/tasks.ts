...
export const tasks: Task[] = [
  {
    ...
    assignedBy: { name: "Ms. Nora Al-Zahrani", role: "Vice Principal", avatar: "NZ" },
  ...
  },
  {
    ...
    assignedBy: { name: "Dr. Khalid Al-Mansouri", role: "Admin", avatar: "DK" },
  ...
  },
  {
    ...
    assignedBy: { name: "Dr. Khalid Al-Otaibi", role: "Vice Principal", avatar: "KO" },
    assignedTo:  { name: "Dr. Sarah Al-Hamdan", role: "Math Teacher", avatar: "SA" },
    assignedToId: "TCH-003",
    dueDate: "Jun 15, 2026",
    status: "in_progress",
  ...
  },
  {
    ...
    assignedBy: { name: "Ms. Nora Al-Zahrani", role: "Vice Principal", avatar: "NZ" },
    assignedTo:  { name: "Mr. Faris Al-Shammari", role: "PE Teacher", avatar: "FS" },
    assignedToId: "TCH-019",
    dueDate: "Jun 27, 2026",
    status: "todo",
    priority: "medium",
...
export const getTasksForRole = (role: string) => {
  ...
  if (role === "teacher") return tasks.filter((t) => t.assignedTo.name === "Dr. Sarah Al-Hamdan");
  return tasks;
};
