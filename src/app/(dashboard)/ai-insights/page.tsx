...
const insights = [
  {
    ...
    dialogBody: "Based on payment history patterns, the following students are at risk of defaulting on Q2 fees:\n\n• Aryan Koul (Grade 11-B) — ₹18,000 outstanding\n• Rohan Sheikh (Grade 8-C) — ₹14,500 outstanding\n• Sara Wani (Grade 9-A) — ₹12,000 outstanding\n• Ali Shah (Grade 12-B) — ₹11,200 outstanding\n• Lina Bhat (Grade 7-A) — ₹9,800 outstanding\n• + 10 more students\n\nTotal exposure: ₹1,78,500\n\nRecommendation: Send automated payment reminders and offer an installment plan to the top 5 at-risk accounts.",
    icon: DollarSign,
    severity: "high",
  },
  {
