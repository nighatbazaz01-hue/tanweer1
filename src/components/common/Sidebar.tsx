...
const navByRole = {
  ...
  admin: [
    ...
    { label: "Mind • Body • Soul", href: "/mind-body-soul",  icon: Brain },
    { label: "Interventions",    href: "/interventions",      icon: ClipboardCheck },
    { group: "Directories" },
  ...
  parent: [
    ...
    { label: "My Child's Wellbeing", href: "/mind-body-soul",   icon: Brain },
    { label: "Interventions",      href: "/interventions",       icon: ClipboardCheck },
    { label: "Transport",          href: "/transport",           icon: Bus },
    { group: "Communication" },
    { label: "Messages",           href: "/messages",            icon: Mail,       badge: "messages" },
  ...
  student: [
    ...
    { label: "My Wellbeing",       href: "/mind-body-soul",          icon: Brain },
    { label: "Transport",          href: "/transport",               icon: Bus },
    { group: "Communication" },
    { label: "Messages",           href: "/messages",                icon: Mail,   badge: "messages" },
    { label: "Notifications",      href: "/notifications",           icon: Bell,   badge: "notif" },
